      ...
      <div className='max-w-4xl mx-auto px-4'> 
        <div className='bg-white rounded-lg shadow p-8'> 
            ...
            <div className='space-y-4'> 
              <div> 
                ...
                <div className='w-full bg-gray-200 rounded-full h-3'> 
                  <div className='bg-gradient-to-r from-blue-500 to-purple-500 h-3 rounded-full transition-all duration-300' style={{ width: `${summary.overallProgress}%` }} /> 
                </div> 
              </div> 
          ...
          <div className='flex gap-4 mt-8'> 
            {summary.failed > 0 && ( 
              <button onClick={handleRetry} disabled={retrying} className='flex items-center gap-2 bg-blue-600 hover:bg-blue-700 disabled:bg-gray-400 text-white px-6 py-2 rounded-lg'> 
